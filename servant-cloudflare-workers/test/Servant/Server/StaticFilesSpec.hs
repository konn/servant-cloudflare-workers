...
module Servant.Cloudflare.Workers.StaticFilesSpec where
...
import Servant.Cloudflare.WorkersSpec (
  Person (Person),
 )
...
withStaticFiles action = withSystemTempDirectory "servant-test" $ \tmpDir ->
